...
flat_pace = df[df['terrain_type'] == 'flat']['avg_pace_min_per_km'].iloc[0] # extract the average pace values
...
downhill_offset = ((downhill_pace - flat_pace) / flat_pace) * 100 # calculate downhill offset
